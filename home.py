...
def home_content():
    ...
    try:
        ...
        st.markdown("""
            \n Di karena dataset load data yang besar maka tidak menampilkan dataset maka dari untuk melihat dataset pada huggeface di link berikut: [link](https://huggingface.co/datasets/emkr-13/Dataset_Berita_Indo)
                    """)
